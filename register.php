...
<div class="navbar-fixed">
    ...
    <!--  <li> <a href="sass.html"><i class="material-icons white-text">search</i></a>     
      ...
      <!-- Search function when you are on small devices -->  
        ...
        <br>
        <h2 class="center black-text">Gå med</h2>
        <?php
        if (!empty($error_msg)) {
            echo $error_msg;
        }
        ?>        
       <div class="row">
        <form class="container" method="post" name="registration_form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
            Användarnamn: <input class="black-text"type="text" name="username" id='username' /><br>
            E-post: <input class="black-text" type="text" name="email" id="email" /><br>
            Lösenord: <input class="black-text" type="password"
                             name="password" 
                             id="password"/><br>
            Bekräfta lösenord: <input class="black-text" type="password" 
                                     name="confirmpwd" 
                                     id="confirmpwd" /><br>
            <button class="btn grey darken-2" type="submit" 
                   value="Register"
                   action="" 
                   onclick="return regformhash(this.form,
                                   ...
                                   this.form.email,
                                   this.form.password,
                                   this.form.confirmpwd);">Gå med</button> 

                                  <fb:login-button scope="public_profile,email" onlogin="checkLoginState();">
</fb:login-button>
        </form>
        <p class="center">Tillbaka till <a href="login.php">logga in</a></p>
         </div>
<!--Footer-->
