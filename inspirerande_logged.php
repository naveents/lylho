...
<!--Quotes wall -->
<br>
<h4 class="container row center">Inspirerande</h4>
...
$sql = "SELECT * FROM quotes WHERE topic='inspirerande' ORDER BY date DESC $limit";
...
function getTotalHumors($conn){
  ...
  $sql   = "SELECT count(*) as total FROM quotes WHERE topic='inspirerande' ORDER BY date DESC";
